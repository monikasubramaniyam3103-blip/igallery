...
<body>
    ...
    <div style="white-space: nowrap; overflow-x: auto; padding: 1rem;">
        <div style="display: inline-block; margin-right: 10px;" onclick="openModal(this)">
            <img src="Screenshot 2025-10-06 184219.png" style="height: 200px;">
        </div>
        <div style="display: inline-block; margin-right: 10px;" onclick="openModal(this)">
            <img src="Screenshot 2025-10-06 183913.png" style="height: 200px;">
        </div>
        <div style="display: inline-block; margin-right: 10px;" onclick="openModal(this)">
            <img src="Screenshot 2025-10-06 184138.png" style="height: 200px;">
        </div>
        <div style="display: inline-block;" onclick="openModal(this)">
            <img src="Screenshot 2025-10-06 184309.png" style="height: 200px;">
        </div>
    </div>
...
```
## OUTPUT:
<img width="1920" height="1080" alt="Screenshot 2025-10-06 184715" src="https://github.com/user-attachments/assets/30eada30-ea6c-471d-8092-8998aabfaa6c" />
